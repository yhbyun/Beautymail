				...
				<table class="w640" border="0" cellpadding="0" cellspacing="0" width="640">
					...
					<tr class="mobile_only">
						<td class="w640" width="640" align="center">
							<a href="{{ $logo['url'] }}"><img class="mobile_only" border="0" src="{{ $logo['path'] }}" alt="{{ $senderName or '' }}" width="{{ $logo['width'] }}" height="{{ $logo['height'] }}" /></a>
						</td>
					</tr>
					<tr class="mobile_only">
						<td class="w640" height="10" width="640"></td>
							...
							<table class="w640" border="0" cellpadding="0" cellspacing="0" width="640">
								<tr>
									...
									<td id="logo" width="{{ $logo['width'] }}" valign="top">
										<a href="{{ $logo['url'] }}"><img border="0" src="{{ $logo['path'] }}" alt="{{ $senderName or ''}}" width="{{ $logo['width'] }}" height="{{ $logo['height'] }}" /></a>
									</td>
								...
								<tr>
									...
									<td valign="top">
										<table align="right">
											...
											<tr>
												@if (isset($twitter))
													<td><a href="http://twitter.com/{{ $twitter }}"><img src="{{ $img_base_url or Request::getSchemeAndHttpHost() . '/vendor/beautymail/assets/images' }}/ark/twitter.png" alt="Twitter" height="25" width="25" style="border:0" /></a></td>
												@endif

												@if (isset($facebook))
													<td><a href="http://facebook.com/{{ $facebook }}"><img src="{{ $img_base_url or Request::getSchemeAndHttpHost() . '/vendor/beautymail/assets/images' }}/ark/fb.png" alt="Facebook" height="25" width="25" style="border:0" /></a></td>
												@endif
											</tr>
										</table>
									</td>
